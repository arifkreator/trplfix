...
</div><div class="form-group {{ $errors->has('telfon') ? 'has-error' : ''}}">
    {!! Form::label('telfon', 'Telfon', ['class' => 'col-md-4 control-label']) !!}
    <div class="col-md-6">
        {!! Form::text('telfon', null, ['class' => 'form-control']) !!}
        {!! $errors->first('telfon', '<p class="help-block">:message</p>') !!}
    </div>
